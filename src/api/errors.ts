...
/**
 * The refresh the backend answered with "another request of yours just rotated this token, send it
 * again" — the loser of a multi-tab race, which is ordinary use rather than a dead session.
 *
