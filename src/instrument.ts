...
/**
 * Imported first by main.tsx, before React, so the SDK's instrumentation is installed before anything
 ...
 * production project. Data collection stays off — this app handles shop-owner credentials, and the one
